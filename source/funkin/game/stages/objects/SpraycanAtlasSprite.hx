...
class SpraycanAtlasSprite extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		Paths.loadAnimateAtlas(canAtlas, 'game/stages/phillyStreets/spraycanAtlas');
		...
		explosion.frames = Paths.getSparrowAtlas('game/stages/phillyStreets/spraypaintExplosionEZ');
