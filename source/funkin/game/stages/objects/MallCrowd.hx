...
class MallCrowd extends BGSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, sprite:String = 'stages/week5/christmas/bottomBop', idle:String = 'Bottom Level Boppers Idle', hey:String = 'Bottom Level Boppers HEY')
	{
