...
class DiscordClient
{
	...
	private static final _defaultID:String = "1362839835219329246";
	...
	public static function changePresence(?details:String = 'Main Menu', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Engine Version: " + MainMenuState.paperEngineVersion;
