package funkin.backend.system.audio.visualize;
...
import funkin.backend.system.audio.visualize.PolygonSpectogram.VISTYPE;
import funkin.backend.system.audio.visualize.VisShit.CurAudioInfo;
