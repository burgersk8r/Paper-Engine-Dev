package funkin.backend.system.util.plugins;
...
import funkin.backend.system.util.FileUtil;
import funkin.backend.system.util.DateUtil;
...
/*   public static function initialize():Void
  ...
  public function hasPressedScreenshot():Bool
  {
    ...
    return controls.justPressed('screenshot');
    #else
    return false;
    #end
  }
